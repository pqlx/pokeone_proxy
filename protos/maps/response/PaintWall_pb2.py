...
# source: maps/response/PaintWall.proto
...
PaintWall = _reflection.GeneratedProtocolMessageType('PaintWall', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.PaintWall_pb2'
