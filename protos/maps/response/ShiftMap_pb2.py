...
# source: maps/response/ShiftMap.proto
...
ShiftMap = _reflection.GeneratedProtocolMessageType('ShiftMap', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.ShiftMap_pb2'
