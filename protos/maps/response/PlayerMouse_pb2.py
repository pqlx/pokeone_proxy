...
# source: maps/response/PlayerMouse.proto
...
PlayerMouse = _reflection.GeneratedProtocolMessageType('PlayerMouse', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.PlayerMouse_pb2'
