...
# source: maps/response/DrawTileStruct.proto
...
DrawTileStruct = _reflection.GeneratedProtocolMessageType('DrawTileStruct', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.DrawTileStruct_pb2'
