...
# source: maps/response/LinkPair.proto
...
LinkPair = _reflection.GeneratedProtocolMessageType('LinkPair', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.LinkPair_pb2'
