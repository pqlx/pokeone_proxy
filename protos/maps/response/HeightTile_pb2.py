...
# source: maps/response/HeightTile.proto
...
HeightChangeStruct = _reflection.GeneratedProtocolMessageType('HeightChangeStruct', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.HeightTile_pb2'
