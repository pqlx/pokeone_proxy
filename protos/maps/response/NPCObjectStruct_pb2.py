...
# source: maps/response/NPCObjectStruct.proto
...
NPCObjectStruct = _reflection.GeneratedProtocolMessageType('NPCObjectStruct', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.NPCObjectStruct_pb2'
