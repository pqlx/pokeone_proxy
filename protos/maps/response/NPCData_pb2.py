...
# source: maps/response/NPCData.proto
...
NPCData = _reflection.GeneratedProtocolMessageType('NPCData', (_message.Message,), dict(
  DESCRIPTOR = _NPCDATA,
  __module__ = 'maps.response.NPCData_pb2'
