...
_UPLOADRESPONSE = _descriptor.Descriptor(
  name='UploadResponse',
  full_name='MAPAPI.Response38.UploadResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='MapName', full_name='MAPAPI.Response38.UploadResponse.MapName', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Succeeded', full_name='MAPAPI.Response38.UploadResponse.Succeeded', index=1,
...
UploadResponse = _reflection.GeneratedProtocolMessageType('UploadResponse', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:MAPAPI.Response38.UploadResponse)
  ))
