...
# source: maps/response/LeaveSession.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='maps/response/LeaveSession.proto',
  package='MAPAPI.Response282865535',
  syntax='proto2',
  serialized_pb=_b('\n maps/response/LeaveSession.proto\x12\x18MAPAPI.Response282865535\"\x1f\n\x0cLeaveSession\x12\x0f\n\x07MapName\x18\x01 \x01(\t')
)
...
LeaveSession = _reflection.GeneratedProtocolMessageType('LeaveSession', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.LeaveSession_pb2'
