...
# source: maps/response/MapServerMap.proto
...
MapServerMap = _reflection.GeneratedProtocolMessageType('MapServerMap', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.MapServerMap_pb2'
