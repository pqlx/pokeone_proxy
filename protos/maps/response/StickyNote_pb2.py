...
# source: maps/response/StickyNote.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='maps/response/StickyNote.proto',
  package='MAPAPI.Response1623491950',
  syntax='proto2',
  serialized_pb=_b('\n\x1emaps/response/StickyNote.proto\x12\x19MAPAPI.Response1623491950\"\x1a\n\nStickyNote\x12\x0c\n\x04Note\x18\x01 \x01(\t')
)
...
StickyNote = _reflection.GeneratedProtocolMessageType('StickyNote', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.StickyNote_pb2'
