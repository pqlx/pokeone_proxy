...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='MAPAPI.Response36',
  syntax='proto2',
  serialized_pb=_b('\n\x10StickyNote.proto\x12\x11MAPAPI.Response36\"\x1a\n\nStickyNote\x12\x0c\n\x04Note\x18\x01 \x01(\t')
)
...
_STICKYNOTE = _descriptor.Descriptor(
  name='StickyNote',
  full_name='MAPAPI.Response36.StickyNote',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Note', full_name='MAPAPI.Response36.StickyNote.Note', index=0,
...
StickyNote = _reflection.GeneratedProtocolMessageType('StickyNote', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:MAPAPI.Response36.StickyNote)
  ))
