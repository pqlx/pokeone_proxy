...
# source: maps/response/CreateNPC.proto
...
CreateNPC = _reflection.GeneratedProtocolMessageType('CreateNPC', (_message.Message,), dict(
  ...
  __module__ = 'maps.response.CreateNPC_pb2'
