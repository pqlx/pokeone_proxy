...
# source: maps/request/JoinMapSession.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='maps/request/JoinMapSession.proto',
  package='MAPAPI.Request1556872628',
  syntax='proto2',
  serialized_pb=_b('\n!maps/request/JoinMapSession.proto\x12\x18MAPAPI.Request1556872628\"!\n\x0eJoinMapSession\x12\x0f\n\x07MapName\x18\x01 \x01(\t')
)
...
JoinMapSession = _reflection.GeneratedProtocolMessageType('JoinMapSession', (_message.Message,), dict(
  ...
  __module__ = 'maps.request.JoinMapSession_pb2'
