...
# source: game/response/Level.proto
...
Level = _reflection.GeneratedProtocolMessageType('Level', (_message.Message,), dict(
  DESCRIPTOR = _LEVEL,
  __module__ = 'game.response.Level_pb2'
