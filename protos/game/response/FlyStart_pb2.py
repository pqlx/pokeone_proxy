...
# source: game/response/FlyStart.proto
...
FlyStart = _reflection.GeneratedProtocolMessageType('FlyStart', (_message.Message,), dict(
  ...
  __module__ = 'game.response.FlyStart_pb2'
