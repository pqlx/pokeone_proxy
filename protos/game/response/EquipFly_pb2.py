...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='EquipFly.proto',
  package='PSXAPI.Response23',
  syntax='proto2',
  serialized_pb=_b('\n\x0e\x45quipFly.proto\x12\x11PSXAPI.Response23\"\x1b\n\x08\x45quipFly\x12\x0f\n\x04Skin\x18\x01 \x01(\x05:\x01\x30')
)
...
_EQUIPFLY = _descriptor.Descriptor(
  name='EquipFly',
  full_name='PSXAPI.Response23.EquipFly',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Skin', full_name='PSXAPI.Response23.EquipFly.Skin', index=0,
...
EquipFly = _reflection.GeneratedProtocolMessageType('EquipFly', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:PSXAPI.Response23.EquipFly)
  ))
