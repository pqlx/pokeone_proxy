...
# source: game/response/LobbyRemove.proto
...
LobbyRemove = _reflection.GeneratedProtocolMessageType('LobbyRemove', (_message.Message,), dict(
  ...
  __module__ = 'game.response.LobbyRemove_pb2'
