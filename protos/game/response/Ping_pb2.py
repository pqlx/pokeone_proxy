...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Ping.proto',
  package='PSXAPI.Response63',
  syntax='proto2',
  serialized_pb=_b('\n\nPing.proto\x12\x11PSXAPI.Response63\x1a\tbcl.proto\"*\n\x04Ping\x12\"\n\x0b\x44\x61teTimeUtc\x18\x01 \x02(\x0b\x32\r.bcl.DateTime')
  ,
...
_PING = _descriptor.Descriptor(
  name='Ping',
  full_name='PSXAPI.Response63.Ping',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='DateTimeUtc', full_name='PSXAPI.Response63.Ping.DateTimeUtc', index=0,
...
Ping = _reflection.GeneratedProtocolMessageType('Ping', (_message.Message,), dict(
  DESCRIPTOR = _PING,
  __module__ = 'Ping_pb2'
  # @@protoc_insertion_point(class_scope:PSXAPI.Response63.Ping)
  ))
