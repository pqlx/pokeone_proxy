...
# source: game/response/Quest.proto
...
Quest = _reflection.GeneratedProtocolMessageType('Quest', (_message.Message,), dict(
  DESCRIPTOR = _QUEST,
  __module__ = 'game.response.Quest_pb2'
