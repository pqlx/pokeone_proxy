...
# source: game/response/LobbyMessage.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/response/LobbyMessage.proto',
  package='PSXAPI.Response1205959546',
  syntax='proto2',
  serialized_pb=_b('\n game/response/LobbyMessage.proto\x12\x19PSXAPI.Response1205959546\"/\n\x0cLobbyMessage\x12\x0f\n\x07Message\x18\x01 \x01(\t\x12\x0e\n\x06Sender\x18\x02 \x01(\t')
)
...
LobbyMessage = _reflection.GeneratedProtocolMessageType('LobbyMessage', (_message.Message,), dict(
  ...
  __module__ = 'game.response.LobbyMessage_pb2'
