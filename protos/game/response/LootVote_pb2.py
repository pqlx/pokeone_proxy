...
# source: game/response/LootVote.proto
...
LootVote = _reflection.GeneratedProtocolMessageType('LootVote', (_message.Message,), dict(
  ...
  __module__ = 'game.response.LootVote_pb2'
