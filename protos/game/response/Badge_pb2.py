...
# source: game/response/Badge.proto
...
Badge = _reflection.GeneratedProtocolMessageType('Badge', (_message.Message,), dict(
  DESCRIPTOR = _BADGE,
  __module__ = 'game.response.Badge_pb2'
