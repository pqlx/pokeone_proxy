...
# source: game/response/Release.proto
...
Release = _reflection.GeneratedProtocolMessageType('Release', (_message.Message,), dict(
  DESCRIPTOR = _RELEASE,
  __module__ = 'game.response.Release_pb2'
