...
# source: game/response/Path.proto
...
Path = _reflection.GeneratedProtocolMessageType('Path', (_message.Message,), dict(
  DESCRIPTOR = _PATH,
  __module__ = 'game.response.Path_pb2'
