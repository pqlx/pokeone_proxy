...
# source: game/response/Time.proto
...
PREFIX_AGDFASBV708095433 = _reflection.GeneratedProtocolMessageType('PREFIX_AGDFASBV708095433', (_message.Message,), dict(
  ...
  __module__ = 'game.response.Time_pb2'
