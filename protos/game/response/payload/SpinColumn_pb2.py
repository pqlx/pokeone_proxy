...
# source: game/response/payload/SpinColumn.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/response/payload/SpinColumn.proto',
  package='PSXAPI.Response.Payload620082600',
  syntax='proto2',
  serialized_pb=_b('\n&game/response/payload/SpinColumn.proto\x12 PSXAPI.Response.Payload620082600\"\x1d\n\nSpinColumn\x12\x0f\n\x07Symbols\x18\x01 \x03(\r')
)
...
SpinColumn = _reflection.GeneratedProtocolMessageType('SpinColumn', (_message.Message,), dict(
  ...
  __module__ = 'game.response.payload.SpinColumn_pb2'
