...
# source: game/response/payload/Banned.proto
...
Banned = _reflection.GeneratedProtocolMessageType('Banned', (_message.Message,), dict(
  DESCRIPTOR = _BANNED,
  __module__ = 'game.response.payload.Banned_pb2'
