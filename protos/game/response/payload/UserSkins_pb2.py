...
# source: game/response/payload/UserSkins.proto
...
UserSkins = _reflection.GeneratedProtocolMessageType('UserSkins', (_message.Message,), dict(
  ...
  __module__ = 'game.response.payload.UserSkins_pb2'
