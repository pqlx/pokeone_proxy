...
_FLYUSERACTIONDATA = _descriptor.Descriptor(
  ...
  full_name='PSXAPI.Response.Payload13.FlyUserActionData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='Action', full_name='PSXAPI.Response.Payload13.FlyUserActionData.Action', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Position', full_name='PSXAPI.Response.Payload13.FlyUserActionData.Position', index=1,
...
_FLYUSERPOSITION = _descriptor.Descriptor(
  ...
  full_name='PSXAPI.Response.Payload13.FlyUserPosition',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='PosX', full_name='PSXAPI.Response.Payload13.FlyUserPosition.PosX', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='PosY', full_name='PSXAPI.Response.Payload13.FlyUserPosition.PosY', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='PosZ', full_name='PSXAPI.Response.Payload13.FlyUserPosition.PosZ', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RotX', full_name='PSXAPI.Response.Payload13.FlyUserPosition.RotX', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RotY', full_name='PSXAPI.Response.Payload13.FlyUserPosition.RotY', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RotZ', full_name='PSXAPI.Response.Payload13.FlyUserPosition.RotZ', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='RotW', full_name='PSXAPI.Response.Payload13.FlyUserPosition.RotW', index=6,
...
FlyUserActionData = _reflection.GeneratedProtocolMessageType('FlyUserActionData', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:PSXAPI.Response.Payload13.FlyUserActionData)
  ))
...
FlyUserPosition = _reflection.GeneratedProtocolMessageType('FlyUserPosition', (_message.Message,), dict(
  ...
  __module__ = 'FlyUserActionData_pb2'
  # @@protoc_insertion_point(class_scope:PSXAPI.Response.Payload13.FlyUserPosition)
  ))
