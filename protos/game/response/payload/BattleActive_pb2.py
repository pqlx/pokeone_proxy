...
# source: game/response/payload/BattleActive.proto
...
BattleActive = _reflection.GeneratedProtocolMessageType('BattleActive', (_message.Message,), dict(
  ...
  __module__ = 'game.response.payload.BattleActive_pb2'
