...
# source: game/response/payload/ZMove.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/response/payload/ZMove.proto',
  package='PSXAPI.Response.Payload236918709',
  syntax='proto2',
  serialized_pb=_b('\n!game/response/payload/ZMove.proto\x12 PSXAPI.Response.Payload236918709\"%\n\x05ZMove\x12\x0c\n\x04move\x18\x01 \x01(\t\x12\x0e\n\x06target\x18\x02 \x01(\t')
)
...
ZMove = _reflection.GeneratedProtocolMessageType('ZMove', (_message.Message,), dict(
  DESCRIPTOR = _ZMOVE,
  __module__ = 'game.response.payload.ZMove_pb2'
