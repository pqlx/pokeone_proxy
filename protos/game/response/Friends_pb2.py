...
# source: game/response/Friends.proto
...
Friend = _reflection.GeneratedProtocolMessageType('Friend', (_message.Message,), dict(
  DESCRIPTOR = _FRIEND,
  __module__ = 'game.response.Friends_pb2'
