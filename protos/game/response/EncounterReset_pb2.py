...
# source: game/response/EncounterReset.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/response/EncounterReset.proto',
  package='PSXAPI.Response1121971087',
  syntax='proto2',
  serialized_pb=_b('\n\"game/response/EncounterReset.proto\x12\x19PSXAPI.Response1121971087\"\x10\n\x0e\x45ncounterReset')
)
...
EncounterReset = _reflection.GeneratedProtocolMessageType('EncounterReset', (_message.Message,), dict(
  ...
  __module__ = 'game.response.EncounterReset_pb2'
