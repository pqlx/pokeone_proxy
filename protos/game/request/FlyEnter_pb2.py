...
# source: game/request/FlyEnter.proto
...
FlyEnter = _reflection.GeneratedProtocolMessageType('FlyEnter', (_message.Message,), dict(
  ...
  __module__ = 'game.request.FlyEnter_pb2'
