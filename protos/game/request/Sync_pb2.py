...
# source: game/request/Sync.proto
...
Sync = _reflection.GeneratedProtocolMessageType('Sync', (_message.Message,), dict(
  DESCRIPTOR = _SYNC,
  __module__ = 'game.request.Sync_pb2'
