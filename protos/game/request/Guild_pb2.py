...
# source: game/request/Guild.proto
...
Guild = _reflection.GeneratedProtocolMessageType('Guild', (_message.Message,), dict(
  DESCRIPTOR = _GUILD,
  __module__ = 'game.request.Guild_pb2'
