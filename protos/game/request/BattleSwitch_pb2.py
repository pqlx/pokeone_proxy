...
# source: game/request/BattleSwitch.proto
...
BattleSwitch = _reflection.GeneratedProtocolMessageType('BattleSwitch', (_message.Message,), dict(
  ...
  __module__ = 'game.request.BattleSwitch_pb2'
