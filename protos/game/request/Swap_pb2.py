...
# source: game/request/Swap.proto
...
Swap = _reflection.GeneratedProtocolMessageType('Swap', (_message.Message,), dict(
  DESCRIPTOR = _SWAP,
  __module__ = 'game.request.Swap_pb2'
