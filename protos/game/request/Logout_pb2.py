...
# source: game/request/Logout.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/request/Logout.proto',
  package='PSXAPI.Request601381925',
  syntax='proto2',
  serialized_pb=_b('\n\x19game/request/Logout.proto\x12\x17PSXAPI.Request601381925\"\x08\n\x06Logout')
)
...
Logout = _reflection.GeneratedProtocolMessageType('Logout', (_message.Message,), dict(
  DESCRIPTOR = _LOGOUT,
  __module__ = 'game.request.Logout_pb2'
