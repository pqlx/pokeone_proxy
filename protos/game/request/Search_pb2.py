...
# source: game/request/Search.proto
...
Search = _reflection.GeneratedProtocolMessageType('Search', (_message.Message,), dict(
  DESCRIPTOR = _SEARCH,
  __module__ = 'game.request.Search_pb2'
