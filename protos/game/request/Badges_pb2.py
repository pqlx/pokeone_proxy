...
# source: game/request/Badges.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/request/Badges.proto',
  package='PSXAPI.Request1423202980',
  syntax='proto2',
  serialized_pb=_b('\n\x19game/request/Badges.proto\x12\x18PSXAPI.Request1423202980\"\x08\n\x06\x42\x61\x64ges')
)
...
Badges = _reflection.GeneratedProtocolMessageType('Badges', (_message.Message,), dict(
  DESCRIPTOR = _BADGES,
  __module__ = 'game.request.Badges_pb2'
