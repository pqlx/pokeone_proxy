...
# source: game/request/Time.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/request/Time.proto',
  package='PSXAPI.Request974141224',
  syntax='proto2',
  serialized_pb=_b('\n\x17game/request/Time.proto\x12\x17PSXAPI.Request974141224\"\x06\n\x04Time')
)
...
Time = _reflection.GeneratedProtocolMessageType('Time', (_message.Message,), dict(
  DESCRIPTOR = _TIME,
  __module__ = 'game.request.Time_pb2'
