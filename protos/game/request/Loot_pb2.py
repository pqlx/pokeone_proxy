...
# source: game/request/Loot.proto
...
Loot = _reflection.GeneratedProtocolMessageType('Loot', (_message.Message,), dict(
  DESCRIPTOR = _LOOT,
  __module__ = 'game.request.Loot_pb2'
