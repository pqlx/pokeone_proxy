...
# source: game/request/Path.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/request/Path.proto',
  package='PSXAPI.Request1625773511',
  syntax='proto2',
  serialized_pb=_b('\n\x17game/request/Path.proto\x12\x18PSXAPI.Request1625773511\x1a\tbcl.proto\"\"\n\x04Path\x12\x1a\n\x07Request\x18\x01 \x01(\x0b\x32\t.bcl.Guid')
  ,
...
Path = _reflection.GeneratedProtocolMessageType('Path', (_message.Message,), dict(
  DESCRIPTOR = _PATH,
  __module__ = 'game.request.Path_pb2'
