...
# source: game/request/Release.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='game/request/Release.proto',
  package='PSXAPI.Request1156003724',
  syntax='proto2',
  serialized_pb=_b('\n\x1agame/request/Release.proto\x12\x18PSXAPI.Request1156003724\x1a\tbcl.proto\"%\n\x07Release\x12\x1a\n\x07Pokemon\x18\x01 \x01(\x0b\x32\t.bcl.Guid')
  ,
...
Release = _reflection.GeneratedProtocolMessageType('Release', (_message.Message,), dict(
  DESCRIPTOR = _RELEASE,
  __module__ = 'game.request.Release_pb2'
