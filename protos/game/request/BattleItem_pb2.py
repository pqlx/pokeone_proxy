...
# source: game/request/BattleItem.proto
...
BattleItem = _reflection.GeneratedProtocolMessageType('BattleItem', (_message.Message,), dict(
  ...
  __module__ = 'game.request.BattleItem_pb2'
