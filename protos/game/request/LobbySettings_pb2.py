...
# source: game/request/LobbySettings.proto
...
LobbySettings = _reflection.GeneratedProtocolMessageType('LobbySettings', (_message.Message,), dict(
  ...
  __module__ = 'game.request.LobbySettings_pb2'
